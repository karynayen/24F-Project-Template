...
INSERT INTO reviewer (major, `name`, `num_co-ops`, `year`, num_posts, bio, active) VALUES
('Computer Science', 'Alice Johnson', 2, 3, 7, 'Passionate about AI and machine learning', TRUE),
('Mechanical Engineering', 'Bob Williams', 1, 2, 3, 'Love designing and building robots', FALSE),
('Business Administration', 'Carol Brown', 3, 4, 12, 'Aspiring entrepreneur with a focus on sustainable business', TRUE),
('Electrical Engineering', 'David Lee', 2, 3, 5, 'Interested in renewable energy systems', TRUE),
('Psychology', 'Emma Davis', 1, 2, 2, 'Fascinated by cognitive neuroscience', FALSE),
('Biology', 'Frank Miller', 2, 3, 6, 'Researching gene therapy applications', TRUE),
('Economics', 'Grace Wilson', 3, 4, 9, 'Passionate about behavioral economics', TRUE),
('Chemistry', 'Henry Taylor', 1, 2, 4, 'Exploring new materials for energy storage', FALSE),
('Political Science', 'Isabella Martinez', 2, 3, 8, 'Interested in international relations', TRUE),
('Physics', 'Jack Anderson', 3, 4, 11, 'Studying quantum computing', TRUE),
('Marketing', 'Karen Thomas', 1, 2, 3, 'Creative mind with a passion for digital marketing', FALSE),
('Environmental Science', 'Liam White', 2, 3, 7, 'Committed to fighting climate change', TRUE),
('Graphic Design', 'Mia Garcia', 3, 4, 10, 'Skilled in UX/UI design', TRUE),
('Mathematics', 'Noah Robinson', 1, 2, 2, 'Fascinated by number theory', FALSE),
('Nursing', 'Olivia Clark', 2, 3, 6, 'Dedicated to improving patient care', TRUE),
('Computer Engineering', 'Peter King', 3, 4, 9, 'Developing cutting-edge IoT devices', TRUE),
('Finance', 'Quinn Adams', 1, 2, 4, 'Interested in blockchain and cryptocurrency', FALSE),
('Aerospace Engineering', 'Rachel Scott', 2, 3, 8, 'Dreaming of space exploration', TRUE),
('Sociology', 'Samuel Baker', 3, 4, 11, 'Studying the impact of social media on society', TRUE),
('Biomedical Engineering', 'Tara Nelson', 1, 2, 3, 'Working on advanced prosthetics', FALSE),
('Architecture', 'Ulysses Hall', 2, 3, 7, 'Passionate about sustainable urban design', TRUE),
('Data Science', 'Victoria Young', 3, 4, 10, 'Applying machine learning to solve real-world problems', TRUE),
('English Literature', 'William Turner', 1, 2, 2, 'Aspiring novelist and literary critic', FALSE),
('Chemical Engineering', 'Xena Rodriguez', 2, 3, 6, 'Developing eco-friendly plastics', TRUE),
('Anthropology', 'Yannick Dubois', 3, 4, 9, 'Studying cultural evolution in the digital age', TRUE),
('Music Production', 'Zoe Phillips', 1, 2, 4, 'Creating innovative electronic music', FALSE),
('Cybersecurity', 'Adam Foster', 2, 3, 8, 'Protecting digital assets from cyber threats', TRUE),
('Neuroscience', 'Bella Chen', 3, 4, 11, 'Researching brain-computer interfaces', TRUE),
('Civil Engineering', "Connor O\'Brien", 1, 2, 3, 'Designing sustainable infrastructure', FALSE),
('Linguistics', 'Diana Kim', 2, 3, 7, 'Fascinated by language acquisition and AI', TRUE),
('Astronomy', 'Ethan Wright', 3, 4, 10, 'Searching for exoplanets', TRUE),
('Biotechnology', 'Fiona Campbell', 1, 2, 2, 'Developing new gene editing techniques', FALSE),
('Information Systems', 'George Patel', 2, 3, 6, 'Optimizing business processes through technology', TRUE),
('Journalism', 'Hannah Stewart', 3, 4, 9, 'Investigating the future of digital media', TRUE),
('Robotics', 'Ian Nguyen', 1, 2, 4, 'Building autonomous robots for search and rescue', FALSE),
('Public Health', 'Julia Fernandez', 2, 3, 8, 'Promoting global health equity', TRUE),
('Materials Science', 'Kevin Chang', 3, 4, 11, 'Developing smart materials for wearable tech', TRUE),
('Philosophy', 'Leah Morgan', 1, 2, 3, 'Exploring ethics in artificial intelligence', FALSE),
('Marine Biology', 'Michael Collins', 2, 3, 7, 'Studying the impact of climate change on coral reefs', TRUE),
('Game Design', 'Natalie Wood', 3, 4, 10, 'Creating immersive VR experiences', TRUE);
