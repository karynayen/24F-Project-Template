...
INSERT INTO company (`companyID`, `name`, `size`) VALUES
(1, 'TechNova Solutions', 5000),
(2, 'GreenLeaf Innovations', 1200),
(3, 'Quantum Dynamics', 8000),
(4, 'SilverStream Systems', 3500),
(5, 'RedRock Analytics', 2000),
(6, 'BlueWave Technologies', 6000),
(7, 'GoldenGate Software', 4500),
(8, 'PurpleMountain Data', 1800),
(9, 'OrangeSky Networks', 7000),
(10, 'BlackDiamond Systems', 2500),
(11, 'WhitePearl Solutions', 3000),
(12, 'EmeraldCity Tech', 5500),
(13, 'RubyRed Innovations', 1500),
(14, 'SapphireBlue Analytics', 4000),
(15, 'AmberGlow Software', 2800),
(16, 'JadeGreen Networks', 6500),
(17, 'TopazYellow Systems', 3200),
(18, 'OpalWhite Technologies', 7500),
(19, 'OnixBlack Solutions', 1900),
(20, 'AquamarineBlue Data', 4200),
(21, 'CoralPink Innovations', 2300),
(22, 'TurquoiseGreen Software', 5800),
(23, 'LavenderPurple Systems', 3700),
(24, 'MaroonRed Networks', 6200),
(25, 'NavyBlue Analytics', 2700),
(26, 'SlateGray Technologies', 4800),
(27, 'IvoryWhite Solutions', 1600),
(28, 'CrimsonRed Software', 5200),
(29, 'IndigoBlue Systems', 3900),
(30, 'OliveGreen Networks', 7200);
...
-- count = 40
INSERT INTO reviewer (reviewerID, major, `name`, `num_co-ops`, `year`, bio, active) VALUES
(1, 'Computer Science', 'Ally Descoteaux', 2, 3, 'Passionate about AI and machine learning', TRUE),
(2, 'Mechanical Engineering', 'Bob Williams', 1, 2, 'Love designing and building robots', FALSE),
(3, 'Business Administration', 'Carol Brown', 3, 4, 'Aspiring entrepreneur with a focus on sustainable business', TRUE),
(4, 'Electrical Engineering', 'David Lee', 2, 3, 'Interested in renewable energy systems', TRUE),
(5, 'Psychology', 'Emma Davis', 1, 2, 'Fascinated by cognitive neuroscience', FALSE),
(6, 'Biology', 'Frank Miller', 2, 3, 'Researching gene therapy applications', TRUE),
(7, 'Economics', 'Grace Wilson', 3, 4, 'Passionate about behavioral economics', TRUE),
(8, 'Chemistry', 'Henry Taylor', 1, 2, 'Exploring new materials for energy storage', FALSE),
(9, 'Political Science', 'Isabella Martinez', 2, 3, 'Interested in international relations', TRUE),
(10, 'Physics', 'Jack Anderson', 3, 4, 'Studying quantum computing', TRUE),
(11, 'Marketing', 'Karen Thomas', 1, 2, 'Creative mind with a passion for digital marketing', FALSE),
(12, 'Environmental Science', 'Liam White', 2, 3, 'Committed to fighting climate change', TRUE),
(13, 'Graphic Design', 'Mia Garcia', 3, 4, 'Skilled in UX/UI design', TRUE),
(14, 'Mathematics', 'Noah Robinson', 1, 2, 'Fascinated by number theory', FALSE),
(15, 'Nursing', 'Olivia Clark', 2, 3, 'Dedicated to improving patient care', TRUE),
(16, 'Computer Engineering', 'Peter King', 3, 4, 'Developing cutting-edge IoT devices', TRUE),
(17, 'Finance', 'Quinn Adams', 1, 2, 'Interested in blockchain and cryptocurrency', FALSE),
(18, 'Aerospace Engineering', 'Rachel Scott', 2, 3, 'Dreaming of space exploration', TRUE),
(19, 'Sociology', 'Samuel Baker', 3, 4, 'Studying the impact of social media on society', TRUE),
(20, 'Biomedical Engineering', 'Tara Nelson', 1, 2, 'Working on advanced prosthetics', FALSE),
(21, 'Architecture', 'Ulysses Hall', 2, 3, 'Passionate about sustainable urban design', TRUE),
(22, 'Data Science', 'Victoria Young', 3, 4, 'Applying machine learning to solve real-world problems', TRUE),
(23, 'English Literature', 'William Turner', 1, 2, 'Aspiring novelist and literary critic', FALSE),
(24, 'Chemical Engineering', 'Xena Rodriguez', 2, 3, 'Developing eco-friendly plastics', TRUE),
(25, 'Anthropology', 'Yannick Dubois', 3, 4, 'Studying cultural evolution in the digital age', TRUE),
(26, 'Music Production', 'Zoe Phillips', 1, 2, 'Creating innovative electronic music', FALSE),
(27, 'Cybersecurity', 'Adam Foster', 2, 3, 'Protecting digital assets from cyber threats', TRUE),
(28, 'Neuroscience', 'Bella Chen', 3, 4, 'Researching brain-computer interfaces', TRUE),
(29, 'Civil Engineering', "Connor O\'Brien", 1, 2, 'Designing sustainable infrastructure', FALSE),
(30, 'Linguistics', 'Diana Kim', 2, 3, 'Fascinated by language acquisition and AI', TRUE),
(31, 'Astronomy', 'Ethan Wright', 3, 4, 'Searching for exoplanets', TRUE),
(32, 'Biotechnology', 'Fiona Campbell', 1, 2, 'Developing new gene editing techniques', FALSE),
(33, 'Information Systems', 'George Patel', 2, 3, 'Optimizing business processes through technology', TRUE),
(34, 'Journalism', 'Hannah Stewart', 3, 4, 'Investigating the future of digital media', TRUE),
(35, 'Robotics', 'Ian Nguyen', 1, 2, 'Building autonomous robots for search and rescue', FALSE),
(36, 'Public Health', 'Julia Fernandez', 2, 3, 'Promoting global health equity', TRUE),
(37, 'Materials Science', 'Kevin Chang', 3, 4, 'Developing smart materials for wearable tech', TRUE),
(38, 'Philosophy', 'Leah Morgan', 1, 2, 'Exploring ethics in artificial intelligence', FALSE),
(39, 'Marine Biology', 'Michael Collins', 2, 3, 'Studying the impact of climate change on coral reefs', TRUE),
(40, 'Game Design', 'Natalie Wood', 3, 4, 'Creating immersive VR experiences', TRUE);
