...
(1, 7, 7, 'Great learning experience', 1, 4, TRUE, 'hourly', 25.50, 'Internship', 'I learned a lot during my time here. The team was supportive and the projects were challenging.', TRUE, '2020-01-15 10:00:00'),
(2, 15, 15, 'Challenging but rewarding', 2, 5, TRUE, 'salary', 75000.00, 'Full-time', 'The work was demanding but I grew professionally. Great company culture.', TRUE, '2020-05-20 14:30:00'),
(3, 23, 23, 'Excellent mentorship', 1, 5, TRUE, 'hourly', 30.00, 'Co-op', 'The mentors were fantastic. I gained valuable industry insights.', FALSE, '2020-09-10 09:45:00'),
(4, 1, 31, 'Fast-paced environment', 3, 4, TRUE, 'salary', 85000.00, 'Full-time', 'Always busy but in a good way. Lots of opportunities to take initiative.', TRUE, '2020-12-05 11:15:00'),
(5, 9, 3, 'Good work-life balance', 2, 4, TRUE, 'hourly', 22.00, 'Part-time', 'Flexible hours and understanding management. Great for students.', FALSE, '2021-03-15 16:00:00'),
(6, 17, 19, 'Innovative projects', 1, 5, TRUE, 'salary', 90000.00, 'Full-time', 'Worked on cutting-edge technology. Very exciting and fulfilling.', TRUE, '2021-06-20 13:30:00'),
(7, 25, 11, 'Supportive team', 1, 4, TRUE, 'hourly', 28.00, 'Internship', 'Everyone was willing to help. Great collaborative atmosphere.', FALSE, '2021-10-10 08:15:00'),
(8, 3, 27, 'Room for growth', 2, 4, TRUE, 'salary', 80000.00, 'Full-time', 'Many opportunities for professional development and advancement.', TRUE, '2022-02-25 09:45:00'),
(9, 11, 35, 'Valuable industry experience', 1, 5, TRUE, 'hourly', 26.50, 'Co-op', 'Gained practical skills that are highly relevant in the job market.', FALSE, '2022-05-15 10:30:00'),
(10, 19, 5, 'Competitive compensation', 3, 5, TRUE, 'salary', 95000.00, 'Full-time', 'Excellent pay and benefits package. Felt valued as an employee.', TRUE, '2022-08-30 15:00:00'),
(11, 27, 13, 'Interesting challenges', 2, 4, TRUE, 'hourly', 24.00, 'Part-time', 'Each day brought new and exciting problems to solve.', FALSE, '2023-01-20 14:00:00'),
(12, 5, 29, 'Great company culture', 1, 5, TRUE, 'salary', 82000.00, 'Full-time', 'Fun work environment with regular team-building activities.', TRUE, '2023-04-15 12:30:00'),
(13, 13, 37, 'Flexible work arrangements', 1, 4, TRUE, 'hourly', 27.00, 'Internship', 'Appreciated the option to work remotely when needed.', FALSE, '2023-08-10 09:00:00'),
(14, 21, 9, 'Strong leadership', 2, 5, TRUE, 'salary', 88000.00, 'Full-time', 'Management was transparent and provided clear direction.', TRUE, '2023-11-05 11:45:00'),
(15, 29, 21, 'Hands-on experience', 1, 4, TRUE, 'hourly', 23.50, 'Co-op', 'Got to work on real projects that impacted the business.', FALSE, '2024-02-15 13:15:00'),
(16, 8, 33, 'Collaborative environment', 3, 4, TRUE, 'salary', 78000.00, 'Full-time', 'Great teamwork and open communication across departments.', TRUE, '2024-05-10 14:45:00'),
(17, 16, 1, 'Learning opportunities', 2, 5, TRUE, 'hourly', 25.00, 'Part-time', 'Constant chances to learn new skills and technologies.', FALSE, '2024-08-20 10:30:00'),
(18, 24, 17, 'Impactful work', 1, 5, TRUE, 'salary', 92000.00, 'Full-time', 'Felt like my work was making a difference in the industry.', TRUE, '2024-10-30 16:00:00'),
(19, 2, 25, 'Supportive management', 1, 4, TRUE, 'hourly', 29.00, 'Internship', 'Managers were always available and willing to provide guidance.', FALSE, '2024-10-30 16:00:00'),
(20, 10, 39, 'Career growth', 2, 5, TRUE, 'salary', 86000.00, 'Full-time', 'Clear path for advancement within the company.', TRUE, '2024-10-30 16:00:00'),
(21, 18, 6, 'Diverse project exposure', 1, 4, TRUE, 'hourly', 26.00, 'Co-op', 'Worked on a variety of projects across different domains.', FALSE, '2024-10-30 16:00:00'),
(22, 26, 14, 'Innovative company', 3, 5, TRUE, 'salary', 98000.00, 'Full-time', "Always pushing the boundaries of what\'s possible in the industry.", TRUE, '2024-10-30 16:00:00'),
(23, 4, 22, 'Friendly colleagues', 2, 4, TRUE, 'hourly', 24.50, 'Part-time', 'Great people to work with, made coming to work enjoyable.', FALSE, '2024-10-30 16:00:00'),
(24, 12, 30, 'Professional development', 1, 5, TRUE, 'salary', 84000.00, 'Full-time', 'Company invested in employee growth through training and conferences.', TRUE, '2021-10-10 08:15:00'),
(25, 20, 38, 'Challenging projects', 1, 4, TRUE, 'hourly', 28.50, 'Internship', 'Assigned to complex projects that pushed me to grow.', FALSE, '2021-10-10 08:15:00'),
(26, 28, 10, 'Work-life balance', 2, 4, TRUE, 'salary', 79000.00, 'Full-time', 'Reasonable hours and respect for personal time.', TRUE, '2021-10-10 08:15:00'),
(27, 6, 18, 'Innovative technology', 1, 5, TRUE, 'hourly', 27.50, 'Co-op', 'Exposure to cutting-edge tools and technologies.', FALSE, '2021-10-10 08:15:00'),
(28, 14, 26, 'Inclusive workplace', 3, 5, TRUE, 'salary', 91000.00, 'Full-time', 'Diverse and welcoming environment for all employees.', TRUE,  '2020-12-05 11:15:00'),
(29, 22, 34, 'Mentorship program', 2, 4, TRUE, 'hourly', 25.50, 'Part-time', 'Paired with experienced professionals for guidance.', FALSE,  '2020-12-05 11:15:00'),
(30, 30, 2, 'Competitive industry position', 1, 5, TRUE, 'salary', 89000.00, 'Full-time', 'Company is a leader in the field with a strong market presence.', TRUE, '2020-12-05 11:15:00'),
(1, 7, 20, 'Room for improvement', 1, 3, FALSE, 'hourly', 22.00, 'Internship', 'Some processes could be more efficient. Communication was lacking at times.', TRUE, '2020-12-05 11:15:00'),
(2, 15, 28, 'High pressure environment', 2, 3, FALSE, 'salary', 72000.00, 'Full-time', 'Very demanding workload with tight deadlines. Not for everyone.', TRUE, '2020-12-05 11:15:00'),
(3, 23, 36, 'Limited resources', 1, 3, FALSE, 'hourly', 26.00, 'Co-op', 'Often had to make do with outdated tools and technology.', FALSE, '2020-12-05 11:15:00'),
(4, 1, 4, 'Bureaucratic processes', 3, 2, FALSE, 'salary', 76000.00, 'Full-time', 'Too much red tape. Simple tasks took forever to complete.', TRUE, '2020-12-05 11:15:00'),
(5, 9, 12, 'Lack of direction', 2, 2, FALSE, 'hourly', 20.00, 'Part-time', 'Objectives were often unclear. Felt lost at times.', FALSE, '2020-12-05 11:15:00');
...
(21, 3), (21, 13), (21, 23), (21, 33), (21, 38),
(22, 4), (22, 14), (22, 24), (22, 34), (22, 37),
(23, 5), (23, 15), (23, 25), (23, 35), (23, 36),
(24, 6), (24, 16), (24, 26), (24, 36), (24, 35),
(25, 7), (25, 17), (25, 27), (25, 37), (25, 34),
(26, 8), (26, 18), (26, 28), (26, 38), (26, 33),
(27, 9), (27, 19), (27, 29), (27, 39), (27, 32),
(28, 10), (28, 20), (28, 30), (28, 40), (28, 31),
(29, 1), (29, 21), (29, 31), (29, 11), (29, 30),
(30, 2), (30, 22), (30, 32), (30, 12), (30, 29);


INSERT INTO `companyIndustry` (industryID, companyID) VALUES
(1, 3), (1, 12), (1, 21), (1, 28), (1, 7),
(2, 15), (2, 4), (2, 25), (2, 9), (2, 30),
(3, 6), (3, 17), (3, 22), (3, 1), (3, 13),
(4, 19), (4, 8), (4, 27), (4, 14), (4, 2),
(5, 11), (5, 23), (5, 5), (5, 29), (5, 16),
(6, 24), (6, 10), (6, 18), (6, 26), (6, 20),
(7, 3), (7, 15), (7, 28), (7, 7), (7, 30),
(8, 12), (8, 25), (8, 1), (8, 17), (8, 4),
(9, 21), (9, 9), (9, 13), (9, 26), (9, 6),
(10, 16), (10, 2), (10, 19), (10, 8), (10, 29),
(11, 5), (11, 22), (11, 11), (11, 27), (11, 14),
(12, 20), (12, 3), (12, 24), (12, 10), (12, 18),
(13, 30), (13, 7), (13, 15), (13, 28), (13, 12),
(14, 25), (14, 1), (14, 17), (14, 4), (14, 21),
(15, 9), (15, 13), (15, 26), (15, 6), (15, 23),
(16, 2), (16, 19), (16, 8), (16, 29), (16, 5),
(17, 22), (17, 11), (17, 27), (17, 14), (17, 20),
(18, 3), (18, 24), (18, 10), (18, 18), (18, 30),
(19, 7), (19, 15), (19, 28), (19, 12), (19, 25),
